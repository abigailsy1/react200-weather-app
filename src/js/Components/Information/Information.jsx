  ...
  render() {
    ...
    return (
      <div className='card border'>
        <div className='card-header alert alert-light text-center'><strong>City Information</strong></div>
        <div className='card-body'>
          <h1 className='text-center'>{city.name}
            {city.weather && <img src={ `//openweathermap.org/img/w/${city.weather[0].icon}.png` } />}
          </h1>
